  ...
  return (
    <div className="relative py-1 sm:py-3 lg:py-6 text-center lg:text-left">
      <div className="space-y-2 sm:space-y-4 lg:space-y-6">
        ...
        <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full bg-gradient-to-r from-blue-950/70 via-slate-900/90 to-cyan-950/70 border border-cyan-500/40 backdrop-blur-md shadow-[0_0_20px_rgba(0,242,254,0.25)]">
          <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-cyan-400 animate-pulse shrink-0" />
          <span className="text-[11px] sm:text-sm font-extrabold tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 via-white to-blue-300 uppercase">
            ⚡ Instant 5-Second Team Delivery
          </span>
        </div>

        {/* Main Futuristic Electric Blue Headline */}
        <h1 className="text-2xl sm:text-4xl lg:text-5xl xl:text-6xl font-heading font-black tracking-tight leading-tight">
          <span className="inline lg:block text-white">Canva Pro </span>
          <span className="inline lg:block text-transparent bg-clip-text bg-gradient-to-r from-[#00F2FE] via-[#3B82F6] to-[#60A5FA] drop-shadow-[0_0_40px_rgba(0,242,254,0.8)]">
            Instant Activation
          </span>
        </h1>

        {/* Sub-headline - full version on desktop, compact on mobile */}
        <p className="hidden lg:block text-base lg:text-lg text-slate-300 max-w-xl mx-auto lg:mx-0 font-medium leading-relaxed">
